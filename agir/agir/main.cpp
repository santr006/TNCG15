...
int main(int argc, char **argv)
{
	...
	//objectToAdd = new Sphere3D(glm::vec3(1.f, 0.f, -1.5f), glm::vec3(0.0f), 0.25f, glm::vec3(1.f, 0.f, 0.f));
	//world.objectList.push_back(objectToAdd);
	
	
	objectToAdd = new Plane3D(glm::vec3(0.f, 0.0f, -2.f), glm::vec3(0.f, 0.f, 0.f), glm::vec2(0.5f), glm::vec3(0.f, 1.f, 0.f));
	world.objectList.push_back(objectToAdd);
